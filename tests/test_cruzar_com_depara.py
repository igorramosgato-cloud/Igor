...
def _depara(nome_origem, unidade, codigo, status="aprovado"):
...
def test_match_exato_nao_precisa_de_depara():
    resultado = cruzar_com_depara([("FULANO DE TAL UM", "filial")], CADASTRO)
...
def test_nao_encontrado_no_exato_e_resolvido_pelo_depara():
    ...
    resultado = cruzar_com_depara([("SICRANO", "filial")], CADASTRO, depara)
...
def test_sem_depara_e_sem_match_exato_fica_nao_encontrado():
    resultado = cruzar_com_depara([("SICRANO", "filial")], CADASTRO, depara=None)
...
def test_ordem_e_sempre_exato_antes_de_depara():
    ...
    resultado = cruzar_com_depara([("FULANO DE TAL UM", "filial")], CADASTRO, depara)
